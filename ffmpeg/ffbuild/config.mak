...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-libfdk_aac --enable-libx264 --enable-nonfree --disable-asm --enable-libpulse --enable-indev=pulse --enable-outdev=pulse --enable-shared
prefix=/usr/local
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shm -lxcb-shape -lxcb-xfixes -lasound -lpulse
EXTRALIBS-avfilter=-pthread -lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lz
EXTRALIBS-avcodec=-pthread -lm -llzma -lz -lfdk-aac -lx264
