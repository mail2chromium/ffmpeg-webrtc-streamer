...
#define FFMPEG_CONFIGURATION "--enable-gpl --enable-libfdk_aac --enable-libx264 --enable-nonfree --disable-asm --enable-libpulse --enable-indev=pulse --enable-outdev=pulse --enable-shared"
