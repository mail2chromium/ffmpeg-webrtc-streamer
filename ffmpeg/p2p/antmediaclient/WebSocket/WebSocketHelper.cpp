...
void CreateSessionDescriptionObserver::OnSuccess(webrtc::SessionDescriptionInterface *desc) {
    ...
    //TODO; Generate takeConfiguration command and send offer
    //    {
...
void WebSocketHelper::on_open(client* c, string *url, string *id,
    ...
    /*TODO; Sending publish command to AntMedia server
    // Command syntax is;
    //{
    //    command : "publish",
    //    streamId : "stream1",
    ...
    json message_object;
    message_object["command"] = "publish";
...
void WebSocketHelper::onmessage(client *s, string *url, string *id, websocketpp::connection_hdl hdl, message_ptr msg) {
    ...
    //response against accepted stream
    //    {
    //        command : "start",
    //        streamId : "stream1",
    //    }

    //response against accepted offer
    //    {
    //        command : "takeConfiguration",
    //            streamId : "stream1",
    //                type : "answer",
    ...
    //response against add candidates
    //    {
    ...
    //response against stream start publishing
    // {
    ...
    std::string type = message_object["command"];
